...
def write_sitemap():
    ...
    One entry. That is not an oversight: every view of this site is the same URL with a
    different hash, and a sitemap listing three hashes of one address would be listing
    the same page three times. When the views get real paths of their own they become
    real entries here.
    """
